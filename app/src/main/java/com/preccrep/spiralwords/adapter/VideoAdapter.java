package com.preccrep.spiralwords.adapter;
...
import com.preccrep.spiralwords.entity.BaseResponse;
import com.preccrep.spiralwords.entity.VideoEntity;
import com.preccrep.spiralwords.listener.OnItemChildClickListener;
import com.preccrep.spiralwords.listener.OnItemClickListener;
import com.preccrep.spiralwords.view.CircleTransform;
...
//        vh.tvCollect.setText(String.valueOf(videoEntity.getCollectNum()));
    ...
    private void updateCount(int vid, int type, boolean flag) {
        ...
        Api.config(ApiConfig.VIDEO_UPDATE_COUNT, params).postRequest(mContext, new PreccrepCallback() {
            @Override
