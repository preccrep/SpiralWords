package com.preccrep.spiralwords.fragment;
...
import com.preccrep.spiralwords.adapter.VideoAdapter;
...
import com.preccrep.spiralwords.entity.VideoEntity;
import com.preccrep.spiralwords.entity.VideoListResponse;
import com.preccrep.spiralwords.listener.OnItemChildClickListener;
import com.preccrep.spiralwords.util.Tag;
import com.preccrep.spiralwords.util.Utils;
...
//        mVideoView.setUrl(proxyUrl);
    ...
    private void getVideoList(final boolean isRefresh) {
        ...
        Api.config(ApiConfig.VIDEO_LIST_BY_CATEGORY, params).getRequest(getActivity(), new PreccrepCallback() {
            @Override
