...
import com.preccrep.spiralwords.activity.WebActivity;
import com.preccrep.spiralwords.adapter.NewsAdapter;
...
import com.preccrep.spiralwords.entity.NewsEntity;
import com.preccrep.spiralwords.entity.NewsListResponse;
...
//                showToast("点击");
    ...
    private void getNewsList(final boolean isRefresh) {
        ...
        Api.config(ApiConfig.NEWS_LIST, params).getRequest(getActivity(), new PreccrepCallback() {
            @Override
