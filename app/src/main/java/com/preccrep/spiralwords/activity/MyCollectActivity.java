...
import com.preccrep.spiralwords.adapter.MyCollectAdapter;
...
import com.preccrep.spiralwords.entity.MyCollectResponse;
...
//        mVideoView.setUrl(proxyUrl);
    ...
    private void getVideoList() {
        ...
        Api.config(ApiConfig.VIDEO_MYCOLLECT, params).getRequest(this, new PreccrepCallback() {
            @Override
